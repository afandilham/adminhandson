                        ...
                        <div class="widget-content p-0">
                            <div class="widget-content-wrapper">
                                <div class="widget-content-left">
                                    <div class="btn-group">
                                        <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="p-0 btn">Akun</a>
                                        <div tabindex="-1" role="menu" aria-hidden="true" class="rm-pointers dropdown-menu-lg dropdown-menu dropdown-menu-right">
                                                ...
                                                <div class="dropdown-menu-header-inner bg-info">
                                                    ...
                                                    <div class="menu-header-content text-left">
                                                        <div class="widget-content p-0">
                                                            <div class="widget-content-wrapper">
                                                                <div class="widget-content-left">
                                                                    <div class="widget-heading"><?php echo $this->session->userdata("nama");?></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <ul class="nav flex-column">
                                                ...
                                                <li class="nav-item-btn text-center nav-item">
                                                    <a href="<?php base_url()?>login/logout" class="btn btn-wide btn-sm btn-primary">Logout</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
